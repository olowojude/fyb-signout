                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 200 200">
                      <path
                        d={(() => {
                          ...
                          const wave = 8;        // amplitude of the wave (bigger bump)
                          const spikes = 60;      // number of bumps around the circle
                          for (let i = 0; i <= spikes; i++) {
                          const angle = (i / spikes) * Math.PI * 2;
                          // sinusoidal radius for wavy edge
                          const radius = r + wave * Math.sin(angle * 6); // “6” = wave frequency multiplier
